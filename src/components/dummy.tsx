        ...
        loadGoogleMapsScript().then(async () => {
            ...
            `;
              ...
              <div style="display:flex; flex-direction:column; gap:8px;">
                ...
                <div style="padding:2px 14px 12px; display:flex; flex-direction:column; gap:4px;">
                  <div class="tooltip-text" style="font-size:17px; font-family:sans-serif; font-weight:600;">
                    ${this.data.name}
                  </div>

                  <div class="tooltip-text" style="display:flex; margin-top:1px; align-items:center; gap:5px; font-size:12.5px; line-height:1;">
                  ...
                  <div class="tooltip-text" style="display:flex; margin-top:1px; align-items:center; gap:6px; font-size:12.5px;">
                  ...
                  <div class="tooltip-text" style="font-size:12.5px; margin-top:1px;">
            ...
            */}
                    ...
                    updateTheme(newTheme: string | undefined) {
                        ...
                        if (tooltip) {
                            tooltip.style.background = newTheme === 'dark' ? "#1a1a1a" : "white";
